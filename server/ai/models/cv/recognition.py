...
=======
            m_paths = os.listdir(os.path.join(os.path.dirname(__file__), 'demo_3'))
            # print(m_paths)

            self.models = [load_model(os.path.join(os.path.dirname(__file__), 'demo_3', path)) for path in m_paths]
>>>>>>> e94cd64b31cd9b39881c45f4b3a63c816bd2f3b5
